...
from token_lib import init_token_counter
...
from auth_lib import is_logged_in, logout
from sidebar_app import sidebar_params, token_placeholder, update_output_tokens
...
i_token_placeholder, o_token_placeholder = token_placeholder()
...
if input_text: 
        ...
        if len(using_collections):  
            for collection in using_collections:
                ...
                partial_chat_response = glib.get_chat_rag_response( # definido en chatbot_lib.py
                    ...
                    input_token_placeholder = i_token_placeholder,
                )
    ...
    update_output_tokens(chat_response, o_token_placeholder)
